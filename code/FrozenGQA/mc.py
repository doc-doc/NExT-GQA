    ...
    for i_batch, batch_dict in enumerate(
        ...
        if args.vg_loss:
            ...
            if data_loader.dataset.mc > 1:
                ...
                qneg_mask = torch.ones_like(qlogits).to(device)
        ...
        if data_loader.dataset.mc > 1:
            ...
            neg_mask = torch.ones_like(logits).to(device)

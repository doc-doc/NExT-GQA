...
We study visually grounded VideoQA by forcing vision-language models (VLMs) to answer questions and simultaneously ground the relevant video moments as visual evidences. We show that this task is easy for human yet is extremely challenging for existing VLMs, revealing that the strong QA performance of these models are actually derived from a short-cut learning of language correlation and irrelevant visual context, versus the causal visual evidence. By defining grounded VQA, we hope to prevent or discourage such short-cut learning and spark more trustworthy techniques. This repository hosts our data and code to facilitate future research.
</details>
